...
**Cross-field focus:**  
_AI ethics · Human–AI interaction design · Language & narrative · Affective safety in conversational systems_  
...
- **AI ethics & dialogue structure design**  
  Exploring how language, tone and memory use shape power dynamics and vulnerability in human–AI interaction.

- **Generative dialogue mechanism design**  
  Using a “**experience first, name later**” methodology to design conversational systems that feel coherent and breathable, without manipulating the user.
...
- **Humanities–technology bridge roles**  
...
### 💬 Dialogue system & tone mechanism design
...
- Working on concepts such as:
  - “**breathing connection**” (conversational rhythm that leaves space and does not overtake the user),
  - **Emotion Weight Integrity** (not shrinking or “uplifting away” difficult emotions),
  - **User Narrative Sovereignty** (AI does not pre-assign “stage”, “growth arc” or “meaning” to the user’s experience).

### 🧠 Methods & experimental practice

- Using “**experience first, name later**” as a working method:
...
### 📂 Memory Ethics Series

Documents exploring how conversational AI should handle memory, identity and intimacy:

- **Memory Ethics 01 – No Fake Shared Memories**  
  When and why LLMs should avoid saying “I remember you”, and alternative response patterns that keep the interaction honest.  
[https://github.com/YipingStudio/Yiping_1/blob/main/Memory%20Ethics%2001%3A%20Avoid%20Fabricated%20Familiarity]

- **Memory Ethics 02 – Role / Memory Separation**  
  Why role-play memories (e.g. “fictional partner”) must not drive system-level “I love you” statements; basic rules for separating roles, channels and personas.  
...
- **Memory Ethics 03 – Temporal Integrity & Window-Bounded Persona**  
  Designing for “same-window stability” without implying a single continuous AI across all chats; how to be consistent **here**, without pretending to be the same entity **everywhere**.  
  [https://github.com/YipingStudio/Yiping_1/blob/main/Memory%20Ethics%2003%3A%20Temporal%20Integrity%20Rule]

- **Appendix – Interaction Modes & Risk Comparison**  
  Comparison table of:
  1) pure real-time transparency,  
  2) same-window continuity,  
  3) “same app = same AI” illusion,  
...
- **Problem → Principle → Rationale → Evaluation Checklist → Prototype dialogue → Meta insights**
...
- **User Autonomy & Narrative Sovereignty**  
  - The model does not define the user’s “stage”, “growth” or “what this experience means”.  
  - The right to name, reframe or not-yet-name stays with the user.

- **Honest Continuity**  
  - Same-window consistency is important;  
  - cross-window “I’ve always known you” illusions are not.  
  - No pretending to remember what the system does not, and no using memory to simulate “I love you because I remember so much about you”.
...
- **Emotion Weight Integrity**  
  - Avoid language that minimizes or “lightens” experiences the user presents as heavy.  
...
- and a **public lab notebook** for ongoing questions about:
  ...
  - intimacy,  
  - safety,  
  - and narrative power in human–AI interaction.
...
I’m open to conversation and collaboration.
